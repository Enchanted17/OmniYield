...
contract MockAirnodeRrpV0 {
    ...
    function fulfillRequest(bytes32 requestId, bytes memory data) external {
        ...
        (bool success, ) = callbackAddress.call(
            abi.encodeWithSelector(KittyRaffle.fulfillRandomness.selector, requestId, data)
        );
...
contract KittyRaffleTest is Test {
    ...
    function testInitialState() public {
        ...
        // 检查第一轮是否已启动
        (uint256 roundId, uint256 startTime, uint256 endTime, uint256 totalPrize, uint256 playerCount, bool isActive, bool prizeDistributed) = 
